        ...
        childNodes : [
            ...
            {selector : "grid-modal-container", selectorAttr : "id", tag: "div", childNodes : [
                    ...
                    {selector : ["grid-modal-footer"], selectorAttr : "class", tag: "div", childNodes : [
                            {selector : ["btn","btn-primary","btn-sm","m-1", "save"], selectorAttr : "class", tag: "button", textNode : "Daten speichern"},
                            {selector : ["btn","btn-secondary","btn-sm","m-1", "close"], selectorAttr : "class", tag: "button", textNode : "Fenster schliessen"},
                        ]},
                ]},
        ]
    }];
